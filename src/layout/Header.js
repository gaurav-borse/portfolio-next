    ...
    <Fragment>
      ...
      >
        ...
        <div className='nav justify-content-center social-icons'>
          <a href='https://www.linkedin.com/in/gaurav-borse/' target='_blank'>
            <i className='fab fa-linkedin-in' />
          </a>
          <a href='https://github.com/gaurav-borse/' target='_blank'>
            <i className='fab fa-github' />
          </a>
          <a href='https://www.instagram.com/gaurav.borse_' target='_blank'>
            <i className='fab fa-instagram' />
          </a>
          <a href='https://dev.to/gauravborse' target='_blank'>
            <i className='fab fa-dev' />
          </a>
          <a href='https://www.facebook.com/Gaurav.Borsee' target='_blank'>
