            ...
            <div className='about-me'>
              <div className='img'>
                <div className='img-in'>
                  <img src='static/img/MyPhoto.png' title='' alt='' />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className='resume-box'>
            ...
            <div className='row'>
              <div className='col-sm-3 col-md-3 col-xl-2'>
                <div className='rb-left'>
                  <img src='static/img/evolvingx-logo.jpeg' title='' alt='' />
                </div>
              </div>
          ...
          <div className='resume-row'>
            <div className='row'>
              <div className='col-sm-3 col-md-3 col-xl-2'>
                <div className='rb-left'>
                  <img src='static/img/shout-logo.png' title='' alt='' />
                </div>
              </div>
              <div className='col-sm-9 col-md-9 col-xl-10'>
                <div className='rb-right'>
          ...
          <div className='resume-row'>
            <div className='row'>
              <div className='col-sm-3 col-md-3 col-xl-2'>
                <div className='rb-left'>
                  <img src='static/img/dds_logo.png' title='' alt='' />
                </div>
              </div>
              <div className='col-sm-9 col-md-9 col-xl-10'>
                <div className='rb-right'>
